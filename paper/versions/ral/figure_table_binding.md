...
artifact stack after the Table I visual redesign pass.
...
- The redesign preserved the existing trace bindings while replacing the prior
  prose-heavy comparison layout with a figure-like panel.
