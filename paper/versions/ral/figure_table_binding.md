...
artifact stack after the Table I matrix redesign pass.
...
- This pass focused on non-Figure-1 manuscript visuals and changed only Table
...
- The redesign preserved the existing trace bindings while replacing the prior
  card-style internal design with a cleaner matrix-style manuscript table.
