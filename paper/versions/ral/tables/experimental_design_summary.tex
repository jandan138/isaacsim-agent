\begin{table}[!t]
\centering
\caption{Experimental design summary. The main factorial comparison covers a shared easy slice plus one harder slice per task family. Two compact ablations isolate action-interface and runtime-validation effects.}
