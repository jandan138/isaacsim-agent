...
As noted in the setup, the empirical frame is descriptive rather than
inferential; the deterministic backend and fixed task set preclude
...
change invalid actions, recovery, and planner/tool call counts. The next empirical
