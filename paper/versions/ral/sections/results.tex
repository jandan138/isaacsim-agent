...
backend and executor are deterministic by design, each cell is interpreted as
a descriptive comparison over a fixed cohort of task instances rather than as
an estimate from repeated stochastic rollouts.
...
overhead across the covered \texttt{P1} versus \texttt{P2} comparisons.
