...
ablation uses clean easy tasks under fixed R0. The repair-probe cohort
was pre-specified from the easy-task pool using a single inclusion
criterion: tasks known to elicit a recoverable invalid-first-action
emission under P1/R0 (one navigation task and one manipulation task per
family). Together they isolate the two
